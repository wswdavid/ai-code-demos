...
class CreateTransfer:
    ...
    def create_transfer_order(
        ...
        """
        Args:
            - appid (str): 申请商户号的AppID或商户号绑定的AppID（企业号corpid即为此AppID）
        ...
        备注:
        - 转账场景/用户收款感知/转账报备信息 存在映射关联关系，可参考 TRANSFER_SCENES 中的配置
        """
        ...
        # ! 3. 验证请求参数
        """
        - 可参考 validate_request_params 方法中的验证场景
        """
        self.validate_request_params(transfer_data)

        # ! 4. 生成签名，构造请求头，发送API请求
